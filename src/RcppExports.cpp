...
RcppExport SEXP _BIMA_Y_regression_region_block_fast(SEXP YSEXP, SEXP MSEXP, SEXP XSEXP, SEXP CSEXP, SEXP L_allSEXP, SEXP num_regionSEXP, SEXP region_idxSEXP, SEXP n_mcmcSEXP, SEXP KSEXP, SEXP stop_burninSEXP, SEXP start_jointSEXP, SEXP lambdaSEXP, SEXP target_accept_vecSEXP, SEXP aSEXP, SEXP bSEXP, SEXP initSEXP, SEXP stepSEXP, SEXP interval_stepSEXP, SEXP interval_thinSEXP, SEXP display_progressSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _BIMA_M_regression_GS(SEXP dataSEXP, SEXP initSEXP, SEXP region_idx_cppSEXP, SEXP kernelSEXP, SEXP n_mcmcSEXP, SEXP display_progressSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_BIMA_Y_regression_region_block_fast", (DL_FUNC) &_BIMA_Y_regression_region_block_fast, 20},
    {"_BIMA_M_regression_GS", (DL_FUNC) &_BIMA_M_regression_GS, 6},
    {"_BIMA_M_regression_region_block", (DL_FUNC) &_BIMA_M_regression_region_block, 19},
    {NULL, NULL, 0}
};

RcppExport void R_init_BIMA(DllInfo *dll) {
